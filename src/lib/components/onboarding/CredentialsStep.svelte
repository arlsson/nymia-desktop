...
<div class="step-content-area">
    ...
    <div class="flex items-center py-1.5 px-3 rounded-md bg-gray-50 mb-3 border-l-3 border-green-600">
    ...
    <form on:submit|preventDefault={testConnection} class="space-y-3">
        ...
        <button
            ...
            class="w-full flex justify-center items-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 disabled:opacity-60 disabled:cursor-not-allowed transition-all duration-150 ease-in-out"
        >
